...
import Pangsit_goreng from '../Assets/Pangsit_goreng.jpg';  // Ensure the path to the image is correct

const EditMenuAdminGenkDimsum = ({ menuName, onSave }) => {
  const navigate = useNavigate();
  const [inputValue, setInputValue] = useState(menuName || 'Genk Dimsum'); // Default to "Genk Dimsum"
      ...
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        <div className="main-content">
          <h2 style={{ textAlign: 'center', fontWeight: 'bold', marginTop: '40px' }}>
            Edit Menu: {menuName || 'Genk Dimsum'}
          </h2>
...
export default EditMenuAdminGenkDimsum;
