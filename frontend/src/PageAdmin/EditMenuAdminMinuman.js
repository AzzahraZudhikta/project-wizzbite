...
// Impor gambar
import Ice_tea from '../Assets/Ice_tea.jpg';  // Pastikan path gambar sesuai dengan struktur folder Anda

const EditMenuAdminMinuman = ({ menuName, onSave }) => {
  const navigate = useNavigate();
  const [inputValue, setInputValue] = useState(menuName || 'Minuman'); // Default ke "Minuman"
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      alert('Nama berhasil di edit'); // Show notification
...
export default EditMenuAdminMinuman;
