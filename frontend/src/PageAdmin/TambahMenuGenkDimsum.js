...
const TambahMenuGenkDimsum = () => {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      navigate('/GenkDimsumAdmin'); // Redirect ke halaman admin setelah jeda
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      <div style={{ display: 'flex', flex: 1, backgroundColor: 'white' }}>
        ...
        >
          <h2 style={{ textAlign: 'center', fontWeight: 'bold', color: '#333' }}>Tambah Menu Genk Dimsum</h2>
          <div
            style={{
              display: 'flex',
...
export default TambahMenuGenkDimsum;
