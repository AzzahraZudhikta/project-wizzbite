...
import MieManja from '../Assets/Mie_manja.jpg'; // Mengganti gambar dengan Mie_manja.jpg

const EditMieManja = () => {
  const navigate = useNavigate();
  const [inputValue, setInputValue] = useState('Mie Manja'); // Default name menjadi "Mie Manja"
      ...
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        <div className="main-content">
          <h2 style={{ textAlign: 'center', fontWeight: 'bold', marginTop: '40px' }}>
            Edit Menu: {inputValue || 'Mie Manja'}
          </h2>
