      ...
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        <div
          ...
          style={{
            flex: 1,
            padding: '20px',
            overflowY: 'auto', // Tambahkan scroll untuk kontainer utama
            height: '100vh', // Pastikan memiliki tinggi penuh
          }}
        >
          ...
          <div
            ...
            style={{
              display: 'flex',
              flexWrap: 'wrap', // Elemen otomatis turun ke baris berikutnya
              gap: '20px',
