  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        {/* Konten Utama */}
        <div
          className="genk-dimsum-container"
          style={{
            padding: '20px',
            flex: 1,
            overflowY: 'auto', // Menambahkan scroll di konten utama
            maxHeight: '90vh', // Membatasi tinggi agar bisa scroll
          }}
        >
          {/* Teks Selamat Datang */}
          ...
          <div
            ...
            style={{
              display: 'flex',
              flexWrap: 'wrap', // Membuat item wrap
          ...
          >
            {itemsTersaring.length > 0 ? (
              itemsTersaring.map((item, index) => (
                <Card
                  key={index}
                  className="menu-card mb-3"
                  style={{
                    width: '30%', // Set width to 30% for 3 items per row
                    boxSizing: 'border-box', // Prevents padding/margin issues
                  }}
                >
